...
const PageHeader = (props) => {
  ...
  return (
      <div className={classes.alignLeft}>
        ...
        <Typography variant="body1" className={classes.fullWidth}>
            See the <Link href="/datastandards/citing/" target="_blank" rel="noopener">Citing PDS Data</Link> documentation for more information on how to use these DOIs to cite PDS data.
        </Typography>
        <br/>
